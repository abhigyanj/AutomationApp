...
class RandomWait:
    ...
    def wait(self):
        ...
        time.sleep(
            self.wait_secs + generateRandomNumber(int(-self.random_wait), int(self.random_wait)))
...
if __name__ == "__main__":
    ...
    start = (
        int(input("Enter Start X: ")) +
        generateRandomNumber(-random_up_and_down, random_up_and_down),
        int(input("Enter Start Y: ")) + generateRandomNumber(-random_up_and_down, random_up_and_down))
    end = (
        int(input("Enter End X: ")) +
        generateRandomNumber(-random_up_and_down, random_up_and_down),
